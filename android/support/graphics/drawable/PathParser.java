  ...
  public static class PathDataNode
  {
    ...
    private static void arcToBezier(Path paramPath, double paramDouble1, double paramDouble2, double paramDouble3, double paramDouble4, double paramDouble5, double paramDouble6, double paramDouble7, double paramDouble8, double paramDouble9)
    {
      ...
      for (paramDouble5 = d1; i < j; paramDouble5 = d3)
      {
        ...
        paramPath.rCubicTo((float)(paramDouble6 * paramDouble9 + paramDouble7) - (float)paramDouble7, (float)(paramDouble8 + paramDouble5 * paramDouble9) - (float)paramDouble8, (float)(d1 - paramDouble9 * d5) - (float)paramDouble7, (float)(d2 - paramDouble9 * d3) - (float)paramDouble8, (float)d1 - (float)paramDouble7, (float)d2 - (float)paramDouble8);
        i += 1;
        paramDouble6 = d5;
        paramDouble9 = d4;
        paramDouble8 = d2;
...
/* Location:              C:\dex2jar-2.0\com.rovio.Nibblers_12230-dex2jar.jar!\android\support\graphics\drawable\PathParser.class
